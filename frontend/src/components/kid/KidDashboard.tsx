...
export default function KidDashboard() {
  ...
  useEffect(() => {
    // Fetch real tasks for the logged-in child
  ...
  const handleCompleteTask = (id: string) => {
    ...
    const reward = tasks.find(t => t._id === id)?.reward || 0;
    ...
    <div className='grid gap-6 p-6 font-sans'>
      ...
      <div className='grid gap-4 md:grid-cols-3'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs'>{completedTasks} completed</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex justify-between'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>{taskCoins}</div>
            <p className='text-xs'>From completed tasks</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
          {tasks.map(task => (
            <Card key={task._id} className='bg-yellow-50 hover:bg-yellow-100 transition-all'>
              <CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <PetShop items={shopItems} coins={coins} onBuy={handleBuy} />
        </CardContent>
      </Card>
