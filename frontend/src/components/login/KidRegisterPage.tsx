...
export default function KidRegisterPage() {
  ...
  return (
    <LoginPage mode='register' userType='child' onSwitchMode={() => navigate("/login/kid")} key={location.pathname}>
      <form onSubmit={handleSubmit} className='grid gap-4'>
        ...
        <div className='grid gap-2'>
          ...
          <Input id='parentId' name='parentId' type='text' placeholder="Enter your parent's ID" value={formData.parentId} onChange={handleChange} required />
        </div>
